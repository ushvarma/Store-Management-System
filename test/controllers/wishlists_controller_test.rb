...
class WishlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wishlist" do
    assert_difference('Wishlist.count') do
      post wishlists_url, params: { wishlist: { wishlistItem: @wishlist.wishlistItem, wname: @wishlist.wname } }
    end
  ...
  test "should update wishlist" do
    patch wishlist_url(@wishlist), params: { wishlist: { wishlistItem: @wishlist.wishlistItem, wname: @wishlist.wname } }
