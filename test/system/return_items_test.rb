...
class ReturnItemsTest < ApplicationSystemTestCase
  ...
  test "creating a Return item" do
    ...
    fill_in "Refundamount", with: @return_item.refundAmount
    fill_in "Returnitemid", with: @return_item.returnItemid
    fill_in "Returnquantity", with: @return_item.returnQuantity
    fill_in "Returntransactionid", with: @return_item.returnTransactionId
    fill_in "Returnuserid", with: @return_item.returnuserId
